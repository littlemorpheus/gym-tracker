...
router.put('/workout/:id/*', workout_controller.update); /* Auth - Owner */
...
router.put('/exercise/:id/*', exercise_controller.update); /* Auth - Owner */
...
//router.put('/document/:id/*', document_controller.update); /* Auth - Owner */
...
router.put('/user/:id/*', user_controller.update); /* Auth - Owner */
...
router.put('/completed_set/:id/*', completed_set_controller.update); /* Auth - Owner */
...
router.put('/completed_exercise/:id/*', completed_exercise_controller.update); /* Auth - Owner */
...
router.put('/completed_workout/:id/*', completed_workout_controller.update); /* Auth - Owner */
